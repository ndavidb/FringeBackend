...
namespace Fringe.Domain.Migrations
{
    ...
    [Migration("20250513022711_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.Performance", b =>
                {
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.ReservedSeat", b =>
                {
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.SeatingPlan", b =>
                {
                    b.Property<int>("SeatingPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SeatingPlanId"));
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.Ticket", b =>
                {
                    b.Property<int>("TicketId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("QRInCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("qrincode");
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.TicketPrice", b =>
                {
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.UserQuery", b =>
                {
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.Performance", b =>
                {
                    b.HasOne("Fringe.Domain.Entities.Show", "Show")
                        .WithMany()
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.ReservedSeat", b =>
                {
                    b.HasOne("Fringe.Domain.Entities.SeatingPlan", "SeatingPlan")
                        .WithMany("ReservedSeat")
                        .HasForeignKey("SeatingPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fringe.Domain.Entities.Ticket", "Ticket")
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.SeatingPlan", b =>
                {
                    b.HasOne("Fringe.Domain.Entities.Venue", "Venue")
                        .WithOne("SeatingPlan")
                        .HasForeignKey("Fringe.Domain.Entities.SeatingPlan", "VenueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fringe.Domain.Entities.Ticket", b =>
                {
                    b.HasOne("Fringe.Domain.Entities.Performance", "Performance")
                        .WithMany("Tickets")
